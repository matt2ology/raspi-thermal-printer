...
- **Printer**: Rongta POS Printer, 80mm Direct Thermal Receipt Printers with Auto Cutter, USB Serial Ethernet Interface, Support Windows/Mac/Linux Cash Drawer, Restaurant Kitchen Printer for ESC/POS (RP332)
